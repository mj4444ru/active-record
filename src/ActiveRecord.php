...
use Traversable;
use Yii\ActiveRecord\Attributes\ConnectionName;
use Yii\ActiveRecord\Attributes\MagicProperty;
use Yii\ActiveRecord\Attributes\TableName;
use Yii\ActiveRecord\Contracts\ActiveRecordInterface;
use Yii\ActiveRecord\Contracts\ActiveRecordManagerInterface;
use Yii\ActiveRecord\Exceptions\UndefinedPropertyException;
